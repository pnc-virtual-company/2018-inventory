...
class materials extends CI_Controller
{
    ...
    public function create()
    {
        ...
        $material            = $this->materials_model->create_material($data_in); //Load to create material in material modal
        if ($material)
    ...
    public function deleteMaterial()
    {
        ...
        $remove_material = $this->materials_model->deleteMaterial($idmaterial); //Load to delete material in material modal by idmaterial
        if ($remove_material) {
            echo "1";
        } else {
            echo "0";
    ...
    public function showEditMaterial()
    {
        ...
        $result           = $this->materials_model->showEditMaterial($showEditMaterial); //Load to show edit material in material modal by showEditMaterial
        if ($result > 0) {
    ...
    public function update()
    {
        ...
        $materialUpdate = $this->materials_model->updateMaterial($idmaterial, $material); //Load to update material in material modal by idmaterial and material
        if ($materialUpdate)
            echo json_encode(array(
                'status' => true
            ));

...
class Departments extends CI_Controller
{
    ...
    public function deleteDepartment()
    {
        ...
        $remove_department = $this->model_department->deleteDepartment($iddepartment); //Load query delete department from database by iddepartment
    ...
    public function showEditDepartment()
    {
        $form         = '';
        $iddepartment = $this->input->post('iddepartment');
        $result       = $this->model_department->showEditDepartment($iddepartment); //Load query show edit department from database by iddepartment
        if ($result > 0) {
    ...
    public function create()
    {
        ...
        $department            = $this->model_department->create_department($data_in); //Load query create department from database by data_in
        if ($department) {
    ...
    public function update()
    {
        ...
        $departmentUpdate = $this->model_department->updateDepartment($iddepartment, $department); //Load query delete department from database by iddepartment and department
        if ($departmentUpdate) {
            echo json_encode(array(
                'status' => true
            ));
